...
**Key Achievements:**
- Mastered LLM implementation with Hugging Face Transformers
- Successfully deployed and debugged 5+ Python projects on CRIL computing cluster
- Developed novel approaches for concept-based medical image interpretation

### Doctoral Researcher - Vision Transformers for Medical Imaging
**[CNRS CRIL UMR 8188](https://www.cril.univ-artois.fr/en/), Artois University, France**  
...
- Cross-dataset validation on multiple benchmark datasets
- Reproducible preprocessing pipeline for medical imaging
...
- Novel preprocessing pipeline for fundus images
- Comprehensive comparison of segmentation architectures
- High-precision lesion detection across multiple lesion types

### Research Intern - Machine Learning for Fault Diagnosis
**[Universitat Politècnica de Catalunya (UPC)](https://www.upc.edu/en), Barcelona, Spain**  
...
**Deliverables:**
- Interactive web-based fault prediction dashboard
...
[← Back to Home](index.html) | [Next: Publications & Supervision →](publications.html)
